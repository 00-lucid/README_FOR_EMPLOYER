...
export function RefreshSideMenuBtn({ setDocumentList }: Props) {
    ...
    const refreshDocumentListCash = async () => {
        ...
        setBanner(`도면 목록 로딩 중...`)

        const documentListRes = await Api.document.refreshDocumentListCash()
