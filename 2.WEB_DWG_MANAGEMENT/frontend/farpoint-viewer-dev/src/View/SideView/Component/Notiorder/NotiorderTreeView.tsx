...
export function NotiorderTreeView({ id, items, extendedIds, selectedIds, style }: Props) {
    // selectIds = order + tagId 
    ...
    return (
        <div className="CommonComponent" id={id} style={style}>
            <div className="NotiorderTreeViewComponent">{treeViewItems.elements}</div>
        </div>
    )
}
