...
export function DocumentDisplaySelect({ documentDisplayType, setDocumentDisplayType }: any) {
    // 전역 Store
    ...
    return (
        <div className={'DocumentDisplaySelect'}>
            <CheckBox
                id="number"
                label={'도면번호'}
                isOn={'number' === documentDisplayType}
                onClickMenu={() => setDocumentDisplayType('number')}
            />
            <CheckBox
                id="name"
                label={'도면이름'}
                isOn={'name' === documentDisplayType}
                onClickMenu={() => setDocumentDisplayType('name')}
            />
        </div>
    )
}
