...
namespace IV.Shared.Interfaces.Services
{
    ...
    public interface IFeedService
    {
        ...
        Task<int> CreateFeedAsync(int albumId, int creatorUserId, string body);
        ...
        /// <returns>생성된 피드의 FeedId (실패 시 0 또는 예외 발생)</returns>
        Task<bool> CreateFeedAlbumPhotoAsync(int feedId, int photoId, int sortOrder);
